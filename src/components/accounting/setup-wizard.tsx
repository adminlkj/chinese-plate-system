...
export default function SetupWizard({ onComplete }: SetupWizardProps) {
  ...
  return (
    <div dir={dir} className="fixed inset-0 z-40 overflow-y-auto bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
      <SetupBackground />

      <div className="relative z-10 w-full max-w-lg mx-auto my-6 sm:my-8 min-h-[calc(100vh-4rem)] flex items-start justify-center">
        <Card className="overflow-hidden border-border/50 shadow-2xl bg-card/90 backdrop-blur-xl max-h-[90vh] flex flex-col">
          {/* Header */}
          ...
          {/* Content */}
          <CardContent className="px-6 pb-4 min-h-[340px] overflow-y-auto flex-1">
